...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const TestUserManagementScreen(),
    );
  }
}
...
class _TestUserManagementScreenState extends State<TestUserManagementScreen> {
  ...
  Future<void> _ejecutarPruebaCompleta() async {
    ...
    // Cambia estos datos por unos de prueba válidos para ti
    ...
    try {
      // 1. Instanciar un objeto Viajero localmente para usar su toMap()
      // (Nota: Pasamos 'cliente' en rol temporalmente, aunque tu clase internamente lo sobrescriba)
      Viajero nuevoViajero = Viajero(
        id: '', // Se generará en Firebase Auth
        nombre: nombreTest,
        email: emailTest,
      ...
      // 4. Verificar qué tipo de usuario nos devolvió el método 'obtenerInformacion'
      setState(() {
      ...
      // Esperar un momento para ver el éxito en pantalla antes de desloguear
